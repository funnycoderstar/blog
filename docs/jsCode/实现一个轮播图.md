...
![img](https://cdn.suisuijiang.com/ImageMessage/5adad39555703565e79040fa_1589115331724.gif)


[代码演示](https://stackblitz.com/edit/img-swiper)

1. 轮播图的原理
![](https://cdn.suisuijiang.com/ImageMessage/5adad39555703565e79040fa_1589114730938.png)
...
```
3. 箭头切换
给左右按钮绑定点击事件，点击的时候，通过修改 wrap 的left值，将下一张图片展示到当前窗口中
```js
